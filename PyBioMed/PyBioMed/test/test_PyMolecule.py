...
def test_pymolecule():
    ...
    from PyBioMed.PyBioMed.PyMolecule.AtomProperty import (
        AtomProperty,
        GetAbsoluteAtomicProperty,
        GetRelativeAtomicProperty,
    )

    from PyBioMed.PyBioMed.PyMolecule.estate import GetEstate
    from PyBioMed.PyBioMed.PyMolecule.constitution import GetConstitutional
    from PyBioMed.PyBioMed.PyMolecule.fingerprint import CalculateECFP4Fingerprint
    from PyBioMed.PyBioMed.PyMolecule.connectivity import GetConnectivity
    from PyBioMed.PyBioMed.PyMolecule.charge import GetCharge
    from PyBioMed.PyBioMed.PyMolecule.bcut import GetBurden
    from PyBioMed.PyBioMed.PyMolecule.basak import Getbasak
    from PyBioMed.PyBioMed.PyMolecule.geary import GetGearyAuto
    from PyBioMed.PyBioMed.PyMolecule.kappa import GetKappa
    from PyBioMed.PyBioMed.PyMolecule.moe import GetMOE
    from PyBioMed.PyBioMed.PyMolecule.molproperty import GetMolecularProperty
    from PyBioMed.PyBioMed.PyMolecule.moran import GetMoranAuto
    from PyBioMed.PyBioMed.PyMolecule.moreaubroto import GetMoreauBrotoAuto
    from PyBioMed.PyBioMed.PyMolecule.topology import GetTopology
    from PyBioMed.PyBioMed.PyMolecule.ghosecrippen import GhoseCrippenFingerprint
    from PyBioMed.PyBioMed.PyMolecule.cats2d import CATS2D
